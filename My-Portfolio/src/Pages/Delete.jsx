...
//     try {
//         const res = await axios.get(`http://localhost:2001/table/${id}`)
...
//         <h1 className="text-4xl font-bold text-center text-green-700 mb-2">Delete</h1>

//         <p className="text-center text-gray-500 mb-8">Delete Data</p>
