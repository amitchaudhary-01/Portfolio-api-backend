...
// Updated Schema to safely handle FileList validation
const schema = z.object({
  ...
  images: z
    .custom((value) => value instanceof FileList || value instanceof Array, {
...
const Form = () => {
  ...
  const onsubmit = async (data) => {
    try {
      ...
      // Safely map and append multiple images
      if (data.images) {
      ...
      >
        ...
        <div>
          ...
          <input
            ...
            multiple
            {...register("images")}
            className="w-full border border-gray-300 rounded-lg p-2 file:bg-indigo-500 file:text-white file:border-0 file:px-4 file:py-2 file:rounded-md file:cursor-pointer"
          />
